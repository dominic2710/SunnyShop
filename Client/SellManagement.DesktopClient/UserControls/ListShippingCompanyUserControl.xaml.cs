...
{
    /// <summary>
    /// Interaction logic for ListCustomerUserControl.xaml
    /// </summary>
    public partial class ListShippingCompanyUserControl : UserControl
    {
        public ListShippingCompanyUserControl()
        {
            InitializeComponent();
        ...
        {
            (this.DataContext as ListShippingCompanyViewModel).IsVisble = this.IsVisible;
        }
        ...
        void OpenNewTab(UserControl userControl, string header)
        {
            ...
            Binding ShippingCompanyCdBinding = new Binding("ShippingCompanyCd");
            ShippingCompanyCdBinding.Source = userControl.DataContext;
            newTabItem.SetBinding(TabItem.HeaderProperty, ShippingCompanyCdBinding);
