...
namespace SellManagement.DesktopClient.UserControls
{
    ...
    public partial class ListSupplierUserControl : UserControl
    {
        ...
        {
            (this.DataContext as ListSupplierViewModel).IsVisble = this.IsVisible;
        }
        ...
        void OpenNewTab(UserControl userControl, string header)
        {
            ...
            Binding supplierCdBinding = new Binding("SupplierCd");
            supplierCdBinding.Source = userControl.DataContext;
            newTabItem.SetBinding(TabItem.HeaderProperty, supplierCdBinding);
