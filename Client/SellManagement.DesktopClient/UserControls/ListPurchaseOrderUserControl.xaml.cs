...
{
    /// <summary>
    /// Interaction logic for ListPurchaseOrderUserControl.xaml
    /// </summary>
    public partial class ListPurchaseOrderUserControl : UserControl
    {
        public ListPurchaseOrderUserControl()
        {
            InitializeComponent();
        ...
        {
            (this.DataContext as ListPurchaseOrderViewModel).IsVisble = this.IsVisible;
        }
        ...
        void OpenNewTab(UserControl userControl, string header)
        {
            ...
            Binding purchaseOrderNoBinding = new Binding("PurchaseOrderNo");
            purchaseOrderNoBinding.Source = userControl.DataContext;
            newTabItem.SetBinding(TabItem.HeaderProperty, purchaseOrderNoBinding);
